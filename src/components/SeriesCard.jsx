...
export const SeriesCard = ({ data }) => {
  ...
  const ButtonPayal = styled.button`
    ...
    <li className={styles.card}>
      ...
      <div className="flex flex-col gap-6 py-[3.2rem] px-[1.2rem]">
        ...
        <a href={watch_url} target="_blank" rel="noopener noreferrer">
          <ButtonPayal rating={rating}>Watch Now</ButtonPayal>
        </a>
      </div>
    </li>
  );
...
// ButtonPayal doesn't need separate propTypes definition, it's internal to SeriesCard
